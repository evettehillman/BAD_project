...
## Put outdir here
OUTDIR=/home/AD/ehillman/Merged_371_sample_files_Saba
mkdir -p $OUTDIR
...
for DIR in "${array[@]}"
        ...
        #Nextseq data
        for READ1 in $(find /usr/share/sequencing/nextseq/processed/$DIR/fastq/ -name "371_SADNA*_S*_R1_001.fastq.gz");
                do
                #create variable names
                SAMPLE=$(basename $READ1 | sed "s/_S1.*_R1_001.fastq.gz//") #strip path and extension
