...
repair.sh -Xmx128g in1=$Prefix\_R1.fastq.gz in2=$Prefix\_R2.fastq.gz out1=$Prefix\_fixed_R1.fastq.gz out2=$Prefix\_fixed_R2.fastq.gz outs=$Prefix\_singletons.fastq.gz repair=t
...
#bbduk.sh -Xmx128g in1=$Prefix\_R1.fastq.gz in2=$Prefix\_R2.fastq.gz out1=$Prefix\_clean_R1.fastq.gz out2=$Prefix\_clean_R2.fastq.gz ordered=$Ordered qtrim=$Qtrim trimq=$Trimq minlen=$Minlen maq=$Maq
